...
from database.db import init_db, create_session, add_turn, update_sessionfrom database.db import get_sessions, get_turns, delete_sessionfrom database.db import delete_all_sessions, get_session_stats
...
# ============================================================
init_db()
st.set_page_config(page_title="InterviewAI Studio", page_icon="AI",
...
# TABS
# ============================================================
tabs = st.tabs(["1. Live Interview", "2. Evaluation",
                "3. Resume and ATS", "4. Coding IDE",
...
with tabs[0]:
    ...
    if st.session_state.manager and st.session_state.current_question:
        ...
        with right:
            mode = st.radio("Answer Mode", ["Voice", "Text"],
            ...
            if mode == "Voice":
                ...
                answer_text = st.text_area(
                    ...
                    placeholder="Type your answer - be specific, concise, reference your real experience...")
        ...
        if st.session_state.history:
            ...
            with c2:
                ...
                <div class="panel-sub">{missed_html}</div></div>
                """, unsafe_allow_html=True)
